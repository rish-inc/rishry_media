...
function rishrymedia_scripts() {
    ...
    wp_enqueue_style( 'reset', get_theme_file_uri( '/css/reset.min.css' ), array(), '1.0.0' );
    wp_enqueue_style( 'style', get_theme_file_uri( '/css/style.css' ), array(), '1.0.0' );
    wp_enqueue_style( 'hamburger', get_theme_file_uri( '/js/hamburger.js' ), array(), '1.0.0', true );
    wp_enqueue_style( 'dorower', get_theme_file_uri( '/js/dorower.js' ), array(), '1.0.0', true );
}
